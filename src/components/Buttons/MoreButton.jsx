...
const MoreButton = ({ openModal }) => {
  return (
    ...
    >
      <div
        onClick={openModal}
        className="h-4 w-4 sm:w-9 sm:h-9 absolute right-0 flex group items-center justify-center rounded-full hover:bg-blue-100 transition ease-in-out cursor-pointer duration-200"
      >
